...
<body>
    <div class="background-container" style="position: absolute; top: -10; right: 5; padding: 10px;">
        ...
        <div class="content">
            ...
            <h2>About Us</h2>
            <p class="homescreenText">Welcome to Our Dispensary make prescriptions and connect pharmacys and
                pharmaceutcal companies</p>
            <h2>Contact Us</h2>
            <p class="homescreenText">Email: info@example.com</p>
            <p class="homescreenText">Phone: 123-456-7890</p>
